...
public class BuyOneGetOneOfferTest {
    ...
    @Before
    public void setup() {
        offerUnderTest = new BuyOneGetOneOffer();
    }
    ...
    public void eligible_offertotal_more_than_one() {
        ...
        BigDecimal discountedPrice = offerUnderTest.discountPrice(20, BigDecimal.valueOf(0.5));
    ...
    public void ineligible_quantities() {
        BigDecimal discountedPrice = offerUnderTest.discountPrice(1, BigDecimal.valueOf(0.5));
